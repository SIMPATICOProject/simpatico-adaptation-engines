...
function initFeatures() {
  ...
  waeUI2.getInstance().init({
		lang: 'it',
		endpoint: 'http://localhost:8888/simp-engines/wae',
...
//  });
  ...
  buttons = [{
                ...
                { // WAE. Switch to the modality, where the form adaptation starts
                    ...
                    isEnabled: function() { return waeUI2.getInstance().isEnabled(); },
                    enable: function() { var idProfile = null; waeUI2.getInstance().enable(idProfile); },
                    disable: function() { waeUI2.getInstance().disable(); }
                  },
                { // CITIZENPEDIA
